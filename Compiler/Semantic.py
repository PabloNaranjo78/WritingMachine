from Compiler.compilador import flag as flag_compilador
from Compiler.compilador import AST
from Compiler.compilador import funciones
from Compiler.compilador import lista_funciones
from Compiler.compilador import lista_errores
...
funcion_reservada = ["ContinueUp", "ContinueDown", "ContinueLeft", "ContinueRight", "Pos", "PosX", "PosY", "Speed",
                     "UseColor"]
            ...
            if i[0] == "Add":
                ...
                if i[1] in variables_globales or i[1] in variables:
                    lista_errores.append(
                        "ERROR: No se puede definir el valor {1} a la variable {0} debido a que ya esta definida".format(
                            i[1], i[2]))
                    flag = False
            ...
            if indicador == "global":
                ...
                # Si el parametro no es una variable pero si un bool
                    ...
                    if bool_aceptado[funcion] == False:
                        lista_errores.append(
                            "ERROR: La función {0} no se puede operar con {1} ya que es un valor booleano".format(
                                funcion, parametro))
                        flag = False
                ...
                # Si la variable no existe en el scope global
                    ...
                    lista_errores.append(
                        "ERROR: La función {0} no se puede operar con el identificador indefinido {1}".format(funcion,
                                                                                                              parametro))
                    flag = False
